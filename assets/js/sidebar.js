function sidebarStart() {
    ...
    document.getElementById('sidebar').innerHTML += "<br><div class='box'><a href='https://www.twitter.com'><img class='icon' src='" + back + "assets/images/twit.svg'/></a><a href='https://www.facebook.com'><img class='icon' src='" + back + "assets/images/fb.svg'/></a></div><div class='box sidebox'><br><p>News related to Homeless</p><br><div id='newsRss'></div><p></p><br></div><div class='box sidebox'></div>";
    
    var userpicture = "HomelessIcons/default.svg";
    
    
rssfeed_url = new Array(); 
rssfeed_url[0]="https://news.google.com/rss/search?q={homeless}";  
...
rssfeed_css_url=""; 
rssfeed_title="on"; 
rssfeed_title_name="Homeless News"; 
...
rssfeed_no_items="0"; 
rssfeed_cache = "eb68ac65fcb4a95338573f2109dd59e7"; 
