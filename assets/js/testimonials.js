...
function testPage() {
    for (var i = 0; i < testimonials.length; i++) {
        ...
        for (var j = 0; j < testimonials[i].testimonialStars; j++) {
            document.getElementsByClassName('stars')[i].innerHTML += "<img class='star' src='assets/images/star.svg'/>"
        }
        for (var j = 0; j <  5 - testimonials[i].testimonialStars; j++) {
            document.getElementsByClassName('stars')[i].innerHTML += "<img class='star gray' src='assets/images/star.svg'/>"
        }
    }
